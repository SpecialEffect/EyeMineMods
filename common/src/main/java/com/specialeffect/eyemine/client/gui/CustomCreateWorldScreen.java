...
//@OnlyIn(Dist.CLIENT)
public class CustomCreateWorldScreen {//extends Screen { TODO: Yet to be re-implemented
...
//      this.worldNameField = new TextFieldWidget(this.font, this.width / 2 - 100, 50, 200, 20, new TranslationTextComponent("selectWorld.enterName"));
...
//
//      this.btnCreateWorld = this.addButton(new Button(this.width / 2 - 155, this.height - 28, 150, 20, new TranslationTextComponent("selectWorld.create"), (p_214318_1_) -> {
//         this.createWorld();
//      }));
//
...
//      this.addButton(new Button(this.width / 2 - 75, 177, 150, 20, new TranslationTextComponent("Advanced Minecraft Options"), (p_214321_1_) -> {
...
//
//         this.minecraft.createWorld(this.saveDirName, this.worldNameField.getText().trim(), worldsettings);
//      }
//   }
//
...
//      this.drawCenteredString(matrixStack, this.font, this.title, this.width / 2, 15, -1);
//
//      this.drawString(matrixStack, this.font, I18n.format("selectWorld.enterName"), this.width / 2 - 100, 37, -6250336);
//      this.drawString(matrixStack, this.font, I18n.format("selectWorld.resultFolder") + " " + this.saveDirName, this.width / 2 - 100, 75, -6250336);
//      this.worldNameField.render(matrixStack, p_render_1_, p_render_2_, p_render_3_);
//
//      this.drawCenteredString(matrixStack, this.font, "Extra EyeMine Options (creative only):", this.width / 2, 95, -1);
//
